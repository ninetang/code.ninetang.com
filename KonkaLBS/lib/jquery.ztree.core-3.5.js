    ...
    //method of operate data
        data = {
            ...
            fixPIdKeyValue: function (setting, node) {
                if (setting.data.simpleData.enableItems) {
    ...
    //method of tools for zTree
        tools = {
            ...
            canAsync: function (setting, node) {
                var childKey = setting.data.key.children;
                return (setting.async.enableItems && node && node.isParent && !(node.zAsync || (node[childKey] && node[childKey].length > 0)));
            },
            clone: function (obj) {
    ...
    //method of operate ztree dom
        view = {
            ...
            switchNode: function (setting, node) {
                ...
                } else if (setting.async.enableItems) {
        ...
        init: function (obj, zSetting, zNodes) {
            ...
            var zTreeTools = {
                ...
                reAsyncChildNodes: function (parentNode, reloadType, isSilent) {
                    if (!this.setting.async.enableItems) return;
            ...
            } else if (setting.async.enableItems && setting.async.url && setting.async.url !== '') {
