...
(function () {
     ...
     * @param {JSON} opts 可选的输入参数，非必填项。可输入选项包括：<br />
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        /**
         * 计算两点间的距离
         * @param {BMap.Point} pxA 经纬度坐标A点.
         * @param {BMap.Point} pxB 经纬度坐标B点.
         * @return 无返回值.
         */
         ...
         * @param {BMap.Point} initPos 经纬度坐标初始点.
         * @param {BMap.Point} targetPos 经纬度坐标目标点.
